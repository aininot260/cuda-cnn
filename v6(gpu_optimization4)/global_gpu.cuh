...
extern __device__ float _conv_z[N_STREAM][CONV_W_NUM][CONV_SIZE][CONV_SIZE];
extern __device__ float _conv_a[N_STREAM][CONV_W_NUM][CONV_SIZE][CONV_SIZE];
...
extern __device__ float _fc1_z[N_STREAM][FC1_SIZE];
extern __device__ float _fc1_a[N_STREAM][FC1_SIZE];
extern __device__ float _fc2_z[N_STREAM][FC2_SIZE];
extern __device__ float _fc2_a[N_STREAM][FC2_SIZE];
extern __device__ float _output[N_STREAM][FC2_SIZE];
extern __device__ int _answer[N_STREAM][FC2_SIZE];
...
extern __device__ float _fc2_delta[N_STREAM][FC2_SIZE];
extern __device__ float _fc1_delta[N_STREAM][FC1_SIZE];
extern __device__ float _conv_sigma_delta[N_STREAM][CONV_W_NUM];
extern __device__ float _conv_delta[N_STREAM][CONV_W_NUM][POOL_SIZE][POOL_SIZE];
